...
```
$ wget https://github.com/azalinux/realvnc-server-aarch64-manjaro/releases/download/realvnc-server-aarch64-v6.10.0/realvnc-vnc-server-6.10.0-1-aarch64.pkg.tar.zst
$ sudo pacman -U realvnc-vnc-server-6.10.0-1-aarch64.pkg.tar.zst
```
