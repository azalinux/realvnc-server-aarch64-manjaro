...
```
$ wget https://github.com/azalinux/realvnc-server-aarch64-manjaro/releases/download/v7.6.0/realvnc-vnc-server-7.6.0-1-aarch64.pkg.tar.zst
$ sudo pacman -U realvnc-vnc-server-7.6.0-1-aarch64.pkg.tar.zst
```
